<?php 
	...
	session_start();
	verifyAccess($db, "Pro nahrávání příspěvků se prosím přihlaste.", "act");
...
//If thy are right check and prepare file
	...
	//Insert into db table
		...
		$sql_insert = "INSERT INTO galery_photos (`header`, `description`, `autor`, `Date`, `URL`, `uploader`) VALUES (:header, :description, :autor, :Date, :URL, :uploader)";
		...
		$_SESSION["error"] = "<p>Soubor nenahrán. Zkontrolujte, zda bylo vše správně vyplněno.</p>";
	}
